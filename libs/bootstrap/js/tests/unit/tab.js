$(function () {
  ...
  QUnit.test('should handle removed tabs', function (assert) {
    ...
    var html = [
      ...
      '      <button class="close opacity-none"><span aria-hidden="true">&times;</span></button>',
      '    </a>',
      '  </li>',
      '  <li class="nav-item">',
      ...
      '      <button id="btnClose" class="close opacity-none"><span aria-hidden="true">&times;</span></button>',
      '    </a>',
      '  </li>',
      '</ul>',
      '<div class="tab-content">',
